...
Scripts, integrations, and assistant skills for working with [Orion](https://docs.runorion.com).

| Example | What it does | Get started |
| --- | --- | --- |
| **Orion Coach** | Helps Claude, Codex, or ChatGPT use Orion through MCP to answer questions and create metrics, dashboards, slides, and workflows. | [Install the skill](skills/README.md) |
